namespace Com.Boombit.CaseStudy.Game.Data
{
    public class EnemyData : CharacterData
    {
        ...
        //  CONSTRUCTORS
        public EnemyData(int id, float maxHealth, float currentHealth, float moveSpeed, float rotationSpeed, float attackDamage, float attackRange, float pathUpdatePeriod, float attackCooldown)
